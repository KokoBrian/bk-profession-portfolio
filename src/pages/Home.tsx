      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <div className="animate-slide-up" style={{ animationDelay: "1s", opacity: 0, animationFillMode: "forwards" }}>
          <p className="text-lg md:text-xl text-white/80 mb-12 max-w-2xl mx-auto leading-relaxed">
            ...
            Explore my teaching journey, philosophy, and the global impact of STEM-focused learning.
          </p>
        </div>
        ...
        <div className="animate-bounce-in flex flex-col sm:flex-row gap-4 justify-center items-center" style={{ animationDelay: "1.5s", opacity: 0, animationFillMode: "forwards" }}>
          <Button variant="hero" size="lg" onClick={goToPortfolio} className="px-8 py-4 text-lg">
            Explore My Portfolio
          </Button>
          <Button variant="outline" size="lg" onClick={goToContact} className="px-8 py-4 text-lg bg-white/10 border-white/30 text-white hover:bg-white/20">
