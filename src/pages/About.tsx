...
import teacherHeadshot from "@/assets/teacher-headshot.jpeg";
  ...
  const cards = [
    {
      ...
      backContent: (
        <div className="space-y-3">
          ...
          <p className="text-sm">B.S. Mathematics Education, UC Berkeley</p>
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto animate-slide-up">
            passionate educator from Kenya who blends the precision of mathematics with the innovation of computer science. Dedicated to inspiring students through STEM education, I aim to prepare learners for global opportunities with creativity and critical thinking. 
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="text-center lg:text-left animate-slide-in-right">
            ...
            <h2 className="text-2xl font-bold text-foreground mb-4">Brian Koko</h2>
                ...
                <div className={`flip-card-inner ${flippedCard === card.id ? 'transform rotateY-180' : ''}`}>
                  ...
                  <Card className="flip-card-back h-full bg-primary text-primary-foreground">
                    <CardContent className="p-6 h-full flex flex-col justify-center">
                      <h3 className="font-semibold text-lg mb-4 text-center">{card.title}</h3>
                      {card.backContent}
                    </CardContent>
                  </Card>
                </div>
